...
function ResumeViewerDialog({
  ...
  return createPortal(
    <AnimatePresence>
      {isOpen ? (
        <motion.div
          className="fixed inset-0 z-[3000] flex items-center justify-center bg-black/75 p-2 font-mono backdrop-blur-sm sm:p-5"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <motion.div
            ...
            className="flex h-[min(94vh,980px)] w-[min(96vw,880px)] flex-col overflow-hidden rounded-xl border border-fuchsia-300/25 bg-[#17131b] shadow-[0_28px_90px_rgba(0,0,0,0.65),0_0_50px_rgba(126,76,164,0.14)]"
            initial={
          ...
          >
            <header className="flex min-h-14 items-center gap-3 border-b border-fuchsia-200/15 bg-[#211a27] px-3 py-2 sm:px-4">
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[10px] text-fuchsia-100/45 sm:text-xs">
                  PDF viewer
                </p>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-fuchsia-200/20 px-2.5 py-2 text-xs text-fuchsia-100/80 transition-colors hover:bg-fuchsia-100/10 hover:text-fuchsia-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-200 sm:px-3"
              >
