...
const WhiteKing = memo(({ className, style }: PieceSVGProps) => (
...
const WhiteQueen = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
...
const WhiteRook = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fill="#fff" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const WhiteBishop = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const WhiteKnight = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const WhitePawn = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
...
const BlackKing = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackQueen = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
...
const BlackRook = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackBishop = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackKnight = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackPawn = memo(({ className, style }: PieceSVGProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" className={className} style={style}>
