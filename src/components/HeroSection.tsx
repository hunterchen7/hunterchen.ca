    ...
    <CanvasComponent offset={offset}>
      <div className="relative flex h-full w-full items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-8 text-lg text-fuchsia-300/80">
            see my{" "}
            <a
